...
public class Constants {
    ...
    public static final String ACTION_SEND_SUCCESS = "edu.illinois.cs.bluetoothobexopp.ACTION_SEND_SUCCESS";
    public static final String EXTRA_FILE_SENT = "FILE_SENT";
    public static final String EXTRA_REMOTE_DEVICE = "REMOTE_DEVICE_ADDRESS";
    ...
    public static final String THIS_PACKAGE_NAME = "edu.illinois.cs.bluetoothobexopp";
    ...
    public static void sendIntentIfCompleted(Context context, Uri contentUri, int status) {
        if (BluetoothShare.isStatusCompleted(status)) {
            ...
            intent.setClassName(THIS_PACKAGE_NAME, "BluetoothOppReceiver");
