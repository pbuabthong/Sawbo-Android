...
public final class BluetoothOppProvider extends ContentProvider {
    ...
    static {
        sURIMatcher.addURI("edu.illinois.cs.bluetoothobexopp.opp", "btopp", SHARES);
        sURIMatcher.addURI("edu.illinois.cs.bluetoothobexopp.opp", "btopp/#", SHARES_ID);
        sURIMatcher.addURI("edu.illinois.cs.bluetoothobexopp.opp", "live_folders/received",
